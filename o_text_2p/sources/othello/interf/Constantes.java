...
public interface Constantes {
    ...
    /** constante qui va définir le nombre de colonnes de la grille */
    final static int NBC = 8;
    
    /** constante qui va définir le nombre de lignes de la grille */
    final static int NBL = 8;
    
    /** constante qui permet de définir la profondeur pour l'IA */
